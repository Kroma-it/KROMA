  ...
  const landing = [
    ...
    return (
        ...
        <div className="flex flex-col items-center gap-10 justify-center text-white pt-40 md:pt-60 pb-6 px-6">
            <p className="text-base md:text-xl text-fuchsia-500 font-medium bg-fuchsia-900/30 px-5 py-2 border border-fuchsia-500/30 rounded-full">Investissement créatif</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 pt-10 pb-4">
            <div className="flex items-center gap-4 mb-2">
                <div className="w-12 h-[2px] bg-gradient-to-r from-fuchsia-500 to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 mb-20">
            <div className="bg-gradient-to-br from-purple-900/60 to-fuchsia-900/30 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-sm">
