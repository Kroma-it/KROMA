    ...
    return (
     <section className="relative mt-[-100px] h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 absolute w-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            <p className="animate-zoomIn border border-fuchsia-400 text-[20px] text-fuchsia-500 bg-fuchsia-900/50 p-2 rounded-full w-fit mx-auto mb-4">
                {data.subtitle}
            </p>
            <h1 className="animate-zoomIn text-7xl font-bold w-3/5 mx-auto leading-tight">
