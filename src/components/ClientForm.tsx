...
export default function ClientForm() {
    // Glassmorphism Card
    return (
        <div className="relative w-full mx-auto min-h-[600px] flex flex-col items-center justify-center px-4 md:p-8 mt-10">

            {/* Header Text */}
            <div className="relative z-10 flex flex-col items-center gap-4 mt-20 md:mt-30 mb-8 px-4">
                <p className="text-fuchsia-500 bg-fuchsia-900/40 p-1 pl-3 pr-3 border border-fuchsia-500/30 rounded-full text-lg md:text-2xl">Feedback Portal</p>
