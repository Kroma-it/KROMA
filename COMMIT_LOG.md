...
**Nom**
Configuration du deploiement Vercel depuis le dossier frontend

**Nature**
Creation

**Details**
- Ajout d'un fichier `vercel.json` a la racine du depot
- Configuration de l'installation des dependances depuis le dossier `frontend`
- Configuration du build Vite depuis le dossier `frontend`
- Definition du dossier de sortie `frontend/dist` pour que Vercel publie la bonne version du site
- Ajout d'une regle de rewrite vers `index.html` pour conserver les routes React en production
