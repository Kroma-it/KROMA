...
export default function Landing({ icon: Icon, cta1, cta1Link, cta2, cta2Link }: LandingProps) {
    return (
        <section className="relative h-screen mb-20 overflow-hidden bg-black">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-kroma-700 to-black/25"></div>
            ...
            <div className="absolute left-1/2 top-1/2 z-10 w-full -translate-x-1/2 -translate-y-1/2 px-4 text-center text-white">
                ...
                <div className="mx-auto mt-10 flex w-full max-w-2xl flex-col items-center justify-center gap-4 md:flex-row md:gap-6">
                    <NavLink
                        to={cta1Link}
                        className="group flex w-full items-center justify-center gap-3 rounded-2xl bg-kroma-600 px-8 py-4 text-lg font-bold text-white shadow-2xl transition-all duration-500 hover:bg-fuchsia-800 active:scale-95 md:w-auto md:text-xl"
                    >
                        <span>{cta1}</span>
