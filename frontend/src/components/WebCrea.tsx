    ...
    <div className="relative w-full max-w-[650px] aspect-square mx-auto flex flex-col items-center justify-center py-6 select-none overflow-visible">
      ...
      {orbitingPods.map((pod) => {
        ...
        return (
          ...
          >
            <div
              className={`group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 border bg-slate-950/75 backdrop-blur-md transition-all duration-300 hover:scale-115 hover:border-white/50 cursor-pointer rounded-full`}
            >
